 ...
 * are <code</code>); this class maintains no internal state while
...
public class Scalr {
     ...
     */
    public final String DEBUG_PROPERTY_NAME = "imgscalr.debug";
     ...
     */
    public final String LOG_PREFIX_PROPERTY_NAME = "imgscalr.logPrefix";
     ...
     */
    public final boolean DEBUG = Boolean.getBoolean(DEBUG_PROPERTY_NAME);
     ...
     */
    public final String LOG_PREFIX = System.getProperty(
     ...
     * @since 3.0
     */
    public final ConvolveOp OP_ANTIALIAS = new ConvolveOp(
     ...
     * @since 4.0
     */
    public final RescaleOp OP_DARKER = new RescaleOp(0.9f, 0, null);
     ...
     * @since 4.0
     */
    public final RescaleOp OP_BRIGHTER = new RescaleOp(1.1f, 0, null);
     ...
     * @since 4.0
     */
    public final ColorConvertOp OP_GRAYSCALE = new ColorConvertOp(
            ColorSpace.getInstance(ColorSpace.CS_GRAY), null);

    /**
     * initializer used to prepare some of the variables used by this
     * class.
     */
    {
     ...
     */
    public final int THRESHOLD_BALANCED_SPEED = 1600;
     ...
     */
    public final int THRESHOLD_QUALITY_BALANCED = 800;
     ...
     *             operations.
     */
    public BufferedImage apply(BufferedImage src, BufferedImageOp... ops)
     ...
     *             operations.
     */
    public BufferedImage crop(BufferedImage src, int width, int height,
     ...
     *             operations.
     */
    public BufferedImage pad(BufferedImage src, int padding,
                                    BufferedImageOp... ops) throws IllegalArgumentException,
            ImagingOpException {
     ...
     * @see Method
     */
    public BufferedImage resize(BufferedImage src, Method scalingMethod,
     ...
     * @see Mode
     */
    public BufferedImage resize(BufferedImage src, Mode resizeMode,
                                       int targetSize, BufferedImageOp... ops)
            throws IllegalArgumentException, ImagingOpException {
     ...
     *             operations.
     */
    public BufferedImage resize(BufferedImage src, int targetWidth,
     ...
     * @see Rotation
     */
    public BufferedImage rotate(BufferedImage src, Rotation rotation,
                                       BufferedImageOp... ops) throws IllegalArgumentException,
            ImagingOpException {
        long t = -1;
        if (DEBUG)
     ...
     */
    public void log(int depth, String message, Object... params) {
//        if (Scalr.DEBUG) {
...
//        }
     ...
     *             if <code>src</code> is <code>null</code>.
     */
    public BufferedImage copyToOptimalImage(BufferedImage src)
            throws IllegalArgumentException {
        if (src == null)
            throw new IllegalArgumentException("src cannot be null");
     ...
     */
    public Method determineScalingMethod(int targetWidth,
...
//            result = Method.BALANCED;
     ...
     *         hint.
     */
    public BufferedImage scaleImageIncrementally(BufferedImage src,
